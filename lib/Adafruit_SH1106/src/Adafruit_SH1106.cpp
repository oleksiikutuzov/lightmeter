...
// The application clears the display during setup, so release builds can skip
// copying the library's startup splash from flash into the framebuffer.
#if defined(LIGHTMETER_NO_DISPLAY_SPLASH)
