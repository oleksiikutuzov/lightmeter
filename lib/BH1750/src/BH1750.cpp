...
#if defined(BH1750_SILENT)
  #define BH1750_PRINT_ERROR(message) ((void)0)
#else
  #define BH1750_PRINT_ERROR(message) Serial.println(F(message))
#endif
...
bool BH1750::configure(Mode mode) {
  ...
  switch (mode) {
    ...
    default:
      ...
      BH1750_PRINT_ERROR("[BH1750] ERROR: Invalid mode");
      break;
  ...
  switch (ack) {
    ...
    case 1: // too long for transmit buffer
      BH1750_PRINT_ERROR("[BH1750] ERROR: too long for transmit buffer");
      break;
    case 2: // received NACK on transmit of address
      BH1750_PRINT_ERROR("[BH1750] ERROR: received NACK on transmit of address");
      break;
    case 3: // received NACK on transmit of data
      BH1750_PRINT_ERROR("[BH1750] ERROR: received NACK on transmit of data");
      break;
    case 4: // other error
      BH1750_PRINT_ERROR("[BH1750] ERROR: other error");
      break;
    default:
      BH1750_PRINT_ERROR("[BH1750] ERROR: undefined error");
      break;
  }
...
bool BH1750::setMTreg(byte MTreg) {
  ...
  if (MTreg <= 31 || MTreg > 254) {
    BH1750_PRINT_ERROR("[BH1750] ERROR: MTreg out of range");
    return false;
  }
  byte ack = 5;
...
float BH1750::readLightLevel(bool maxWait) {
  ...
  if (BH1750_MODE == UNCONFIGURED) {
    BH1750_PRINT_ERROR("[BH1750] Device is not configured!");
    return -2.0;
  }
